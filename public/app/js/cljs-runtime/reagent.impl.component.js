...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__11601 = c;
var G__11601__$1 = (((G__11601 == null))?null:G__11601.prototype);
if((G__11601__$1 == null)){
return null;
} else {
return G__11601__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__11604 = c;
var G__11604__$1 = (((G__11604 == null))?null:G__11604.prototype);
if((G__11604__$1 == null)){
return null;
} else {
return G__11604__$1.render;
}
})() == null)))));
});
...
var or__5045__auto__ = (function (){var G__11612 = c;
var G__11612__$1 = (((G__11612 == null))?null:G__11612.constructor);
if((G__11612__$1 == null)){
return null;
} else {
return G__11612__$1.displayName;
}
})();
...
var G__11613 = c;
var G__11613__$1 = (((G__11613 == null))?null:G__11613.constructor);
if((G__11613__$1 == null)){
return null;
} else {
return G__11613__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__11614 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__11615 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__11615);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__11614);
}});
reagent.impl.component.rat_opts = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"no-cache","no-cache",1588056370),true], null);
reagent.impl.component.custom_wrapper = (function reagent$impl$component$custom_wrapper(key,f){
var G__11617 = key;
var G__11617__$1 = (((G__11617 instanceof cljs.core.Keyword))?G__11617.fqn:null);
switch (G__11617__$1) {
...
var c = this;
var G__11654_11706 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__11654_11706 == null)){
} else {
reagent.ratom.dispose_BANG_(G__11654_11706);
}
...
var renders_11707 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_11708 = cljs.core.first(cljs.core.vals(renders_11707));
...
if((cljs.core.count(renders_11707) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_11707))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_11708)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_11708], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__11689 = o;
reagent.impl.component.goog$module$goog$object.set(G__11689,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__11690 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__11691 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__11691);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__11690);
}});
...
var vec__11692 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11692,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11692,(1),null);
...
var G__11695 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__11695 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__11695);
}
});
}),[]);
