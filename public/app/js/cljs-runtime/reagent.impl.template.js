...
var G__11717 = o;
reagent.impl.template.goog$module$goog$object.set(G__11717,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__11735__delegate = function (args){
...
while (G__11736__i < G__11736__a.length) {G__11736__a[G__11736__i] = arguments[G__11736__i + 0]; ++G__11736__i;}
  args = new cljs.core.IndexedSeq(G__11736__a,0,null);
} 
return G__11735__delegate.call(this,args);};
...
return G__11735__delegate(args);
});
...
var G__11718 = o;
reagent.impl.template.goog$module$goog$object.set(G__11718,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__11719 = props;
var G__11719__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11719,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__11719);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11719__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__11720 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11720,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__11720;
}
})(),id_class);
...
var G__11721 = (cljs.core.count(argv) - first_child);
switch (G__11721) {
case (0):
...
var vec__11722 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11722,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11722,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11722,(2),null);
...
var temp__5808__auto___11748 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___11748 == null)){
} else {
var key_11749 = temp__5808__auto___11748;
(jsprops.key = key_11749);
}
...
var key_11755 = temp__5808__auto___11754;
...
var temp__5808__auto___11765 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___11765 == null)){
} else {
var key_11766 = temp__5808__auto___11765;
(jsprops.key = key_11766);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11725_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__11725_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__11726 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11726,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11726,(1),null);
...
break;
default:
var G__11776 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__11777 = compiler;
v = G__11776;
compiler = G__11777;
continue;
...
var G__11730 = tag;
var G__11730__$1 = (((G__11730 instanceof cljs.core.Keyword))?G__11730.fqn:null);
switch (G__11730__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template11732 = (function (opts,id,fn_to_element,parse_fn,meta11733){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template11732.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11734,meta11733__$1){
var self__ = this;
var _11734__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template11732(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta11733__$1));
}));

(reagent.impl.template.t_reagent$impl$template11732.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11734){
var self__ = this;
var _11734__$1 = this;
return self__.meta11733;
}));

(reagent.impl.template.t_reagent$impl$template11732.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template11732.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template11732.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template11732.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template11732.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template11732.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta11733","meta11733",907641874,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template11732.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template11732.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template11732");

(reagent.impl.template.t_reagent$impl$template11732.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template11732");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template11732.
 */
reagent.impl.template.__GT_t_reagent$impl$template11732 = (function reagent$impl$template$__GT_t_reagent$impl$template11732(opts,id,fn_to_element,parse_fn,meta11733){
return (new reagent.impl.template.t_reagent$impl$template11732(opts,id,fn_to_element,parse_fn,meta11733));
});
...
return (new reagent.impl.template.t_reagent$impl$template11732(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
